...
export class Simulator {
  ...
  step(dt: number): void {
    ...
    const frictionMult = piece.id === 'RAMP_UP' || piece.id === 'RAMP_DN' || piece.id === 'STEEP_HILL' || piece.id === 'HELIX_UP' || piece.id === 'HELIX_DN' || piece.id === 'SPIRAL_TOWER' ? RAMP_FRICTION_MULT : 1.0;
